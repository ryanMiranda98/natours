...
// Function to filter fields to update
...
// updates user data for users that are logged in
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  // We only want to update name and email, so filter out unwanted fields
...
// updates user data as an admin(Not sensitive data like passwords)
