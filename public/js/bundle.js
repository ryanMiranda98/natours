...
var showAlert = function showAlert(type, msg) {
  // Hide alerts that already exist
  hideAlert();
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoicnlhbm1pcmFuZGEiLCJhIjoiY2tkNXlmcjAwMDV3bTJybjVtcHMzamwxYyJ9.PS5yoJI1oNkqX6fYJFwoGQ";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/ryanmiranda/ckd5z4t4706mg1in4yjic7h5s",
    scrollZoom: false // lng, lat
...
var stripe = Stripe("pk_test_51HB4MwFsdxkHbxOdfdRrqKd6RUR1wxIgvCPQoiVweDVA9mpxWFyfU0R0ZoyQ6P3uHdOQzBGFzFHKevr9OS2fBHqf00XLcKcTTu");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "http://localhost:5000/api/v1/bookings/checkout-session/".concat(tourId)
            });
...
// DOM elements; avoids displaying errors on pages that dont have map
